...
cv2.rectangle(img,box_coordinates[0],box_coordinates[1],rectangle_bgr,cv2.FILLED)
...
while True:
    ...
    cv2.putText(frame,status,(x1+int(w1/10),y1+int(h1/2)),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,0.7,(0,0,255),2)
    cv2.putText(frame,status,(100,150),font,3,(0,0,255),2,cv2.LINE_4)
    cv2.rectangle(frame,(x,y),(x+2,y+h),(0,0,255))
